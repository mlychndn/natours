...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bouns to include current location
...
var showAlert = function showAlert(type, msg) {
  hideAlert(); //console.log('Malay Chandan');
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), "  uploaded sucessfully!"));
            }
...
var stripe = Stripe('pk_test_51IVgVMK5BvXFrm8bK9zpKkjVAD8j5ke0ykhhJqCv38kUYFQQaXJpca3pONNgHmHF9i99ZsPTPkltkTcHgU2dS6Gh003vzQbnuI');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/checkout/".concat(tourId));
